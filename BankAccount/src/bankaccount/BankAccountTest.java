            ...
            switch(menu) {
                ...
                case "4" -> {
                    try {
                        ...
                        System.out.println(String.format("Saldo akhir objek %s no.rek %s Bank %s adalah Rp. %.0f,00",
                                        p.get(i-1).getNama(),
                                        noRek,
                ...
                case "6" -> {
                    try {
                        ...
                        System.out.println(String.format(" (Pengirim) Saldo akhir objek %s no.rek %s Bank %s adalah Rp. %.0f,00",
                                        p.get(i-1).getNama(),
                                        noRek,
                                        p.get(i-1).getAkunBank(noRek).getBank(),
                                        p.get(i-1).getAkunBank(noRek).getSaldo()
                                     ));
                        System.out.println(String.format(" (Penerima) Saldo akhir objek %s no.rek %s Bank %s adalah Rp. %.0f,00",
                                        p.get(x-1).getNama(),
                                        noRekPenerima,
                ...
                case "7" -> {
                    for (int i=0;i<p.size();i++) {
                        System.out.println(String.format("%d. [nama: %s] [umur: %d] [total saldo semua bank : Rp. %.0f,00]",
                                        i+1,
                                        p.get(i).getNama(),
                                        p.get(i).getUmur(),
